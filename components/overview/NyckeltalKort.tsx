...
export interface NyckeltalKortProps {
  ...
  const kpis = [
    {
      ...
      value: totaltAntalRapporter.toLocaleString(),
      icon: FileText,
    ...
    },
    {
      ...
      value: genomsnittDagar.toFixed(1),
      icon: Clock,
    ...
    },
    {
      ...
      value: aktivaKategorier.toLocaleString(),
      icon: FolderKanban,
